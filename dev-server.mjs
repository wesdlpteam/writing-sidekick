  ...
  powerUps: [
    {
      ...
      skill: "Put your reader on the sand",
      why: "'I got dumped!' is a great moment; adding when and where lets your reader see the beach too.",
      yourLine: "The waves were huge and I got dumped!",
      rule: "Add when it happened at the front with a comma, and where it happened at the end.",
    ...
    },
    {
      ...
      skill: "Start with While or When",
      why: "'After that' links your events nicely; a While or When start makes the sentence flow like a story.",
      yourLine: "After that we had fish and chips.",
      rule: "Begin with While or When, say what was happening, add a comma, then finish the sentence.",
