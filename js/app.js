...
// Some slides open with a short clip of the sidekick (power-up, hero scan). It plays once,
// muted, from the start each time the slide opens, and ends on its last frame. If the browser
